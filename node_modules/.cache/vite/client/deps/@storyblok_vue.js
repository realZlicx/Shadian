...
var q = (o) => new Promise((e, t) => {
  ...
  s.async = true, s.src = o, s.id = "storyblok-javascript-bridge", s.onerror = (r) => t(r), s.onload = (r) => {
    x.forEach((n) => n()), S = true, e(r);
  }, document.getElementsByTagName("head")[0].appendChild(s);
});
var V = Object.defineProperty;
var D = (o, e, t) => e in o ? V(o, e, { enumerable: true, configurable: true, writable: true, value: t }) : o[e] = t;
var h = (o, e, t) => (D(o, typeof e != "symbol" ? e + "" : e, t), t);
function C(o) {
...
var T;
var E = "https://app.storyblok.com/f/storyblok-v2-latest.js";
var $e = (o, e, t = {}) => {
  var s;
...
var Re = (o = {}) => {
  ...
  return s !== false && p && q(E), T = new k(l.schema), l.resolver && I(T, l.resolver), u;
};
var I = (o, e) => {
  o.addNode("blok", (t) => {
    let s = "";
...
var _e = (o) => !o || !(o != null && o.content.some((e) => e.content || e.type === "blok" || e.type === "horizontal_rule"));
var Ce = (o, e, t) => {
  let s = t || T;
  if (!s) {
    console.error(
...
var Ie = {
  install(o, e = {}) {
    o.directive("editable", je), o.component("StoryblokComponent", Te), e.enableFallbackComponent && !e.customFallbackComponent && o.component(
      "FallbackComponent",
      defineAsyncComponent(() => import("./FallbackComponent-ddf2f161-SJVTRGR6.js"))
    );
